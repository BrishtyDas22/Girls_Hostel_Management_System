...
<body>
    ...
    <div id="room_info2">
        <form method="post" id="booking-form2">
            ...
            <h3>Room Info:</h3>
            <label id="r2">Room No:</label>
            <label id="p2">Price:</label>
    ...
    <div id="room_info3">
        <form method="post" id="booking-form3">
            ...
            <h3>Room Info:</h3>
            <label id="r3">Room No:</label>
            <label id="p3">Price:</label>
    ...
    <div id="room_info5">
        <form method="post" id="booking-form5">
            ...
            <h3>Room Info:</h3>
            <label id="r5">Room No:</label>
            <label id="p5">Price:</label>
    ...
    <div id="room_info6">
        <form method="post" id="booking-form6">
            ...
            <h3>Room Info:</h3>
            <label id="r6">Room No:</label>
            <label id="p6">Price:</label>
